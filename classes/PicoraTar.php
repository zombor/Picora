...
//@@PicoraAutoLoader PicoraAutoLoader::addFile('PicoraTar',$path.'/classes/PicoraTar.php');

/**
 * This class is a thin wrapper around Josh Barger's [PHP TAR](http://www.phpclasses.org/browse/package/529.html) implementation.
 *   <br/><br/><br/>
 * @introduction Create and unpack TAR files.
 */
class PicoraTar {	
	/**
