...
//@@PicoraAutoLoader PicoraAutoLoader::addFile('PicoraXMLRPC',$path.'/classes/PicoraXMLRPC.php');
//@@PicoraAutoLoader PicoraAutoLoader::addFile('PicoraXMLRPCController',$path.'/classes/PicoraXMLRPC.php');
//@@PicoraDispatcher PicoraDispatcher::addRoute('/rpc',array('PicoraXMLRPCController','respond'));

/**
 * Provides a thin wrapper around the [Inutio XMLRPC Library](http://scripts.incutio.com/xmlrpc/)
 * <pre class="highlighted"><code class="php">//server
...
class PicoraXMLRPCController extends PicoraController {
...
class IXR_Client {
    ...
    public $error = false;
    function __construct($server, $path = false, $port = 80, $timeout = 30, $vendor = '') {
        if (!$path) {
