...
//@@PicoraAutoLoader PicoraAutoLoader::addFile('PicoraTextile',$path.'/classes/PicoraTextile.php');

/**
 * This class is a thin wrapper around the [TextilePHP](http://jimandlissa.com/project/textilephp) library which is an implementation of Dean Allen's [Textile](http://www.textism.com/tools/textile/) language.
 * <pre class="highlighted"><code class="php">PicoraTextile::format('some text');</code></pre>
 * @introduction Generate HTML from Textile formatted text.
 * @event void PicoraTextile.beforeFormat(string text)
 * @event void PicoraTextile.afterFormat(string text)
 */
class PicoraTextile {
	/**
